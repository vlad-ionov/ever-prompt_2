    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className={`sm:max-w-[600px] max-h-[90svh] flex flex-col ${isDarkMode ? 'bg-[#141414] border-[#262626]' : 'bg-white border-[#d4d4d4]'}`}>
        <DialogHeader className="flex-shrink-0">
          <DialogTitle className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>Edit Prompt</DialogTitle>
        ...
        <div className="grid gap-4 py-4">
          <div className="grid gap-2">
            <Label htmlFor="edit-title" className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>
              Title
            </Label>
            <Input
              id="edit-title"
          ...
          <div className="grid gap-2">
            <Label htmlFor="edit-description" className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>
              Description
            </Label>
            <Input
              id="edit-description"
          ...
          <div className="grid gap-2">
            <Label htmlFor="edit-type" className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>
              Type
            </Label>
          ...
          <div className="grid gap-2">
            <Label htmlFor="edit-model" className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>
              Model
            </Label>
          ...
          <div className="grid gap-2">
            <Label htmlFor="edit-tags" className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>
              Tags
            </Label>
            <Input
              id="edit-tags"
          ...
          <div className="grid gap-2">
            <Label htmlFor="edit-content" className={isDarkMode ? 'text-[#f5f5f5]' : 'text-[#333333]'}>
              Prompt Content
            </Label>
            <Textarea
              id="edit-content"
              ...
              className={`h-[200px] overflow-y-auto ${isDarkMode ? 'border-[#262626] bg-[#0f0f0f] text-[#f5f5f5] placeholder:text-[#606060] focus-visible:ring-[#60a5fa]' : 'border-[#d4d4d4] bg-white focus-visible:ring-[#E11D48]'} resize-none`}
            />
          </div>
        </div>
